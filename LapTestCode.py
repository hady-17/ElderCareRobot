...
#ip_camera_url = "http://192.168.1.102:8080/video"  # Replace with your IP
cap = None
...
def analyze_video_for_face(video_path):
    ...
    while True:
        ...
        if cropped_retry is not None:
            ...
            name =recognize_face_from_frame(cropped_retry) #recognize_face()recognize_face_from_frame(cropped_retry)
